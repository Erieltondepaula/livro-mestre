...
Ideal para: seminários, conferências, pregadores experientes, estudos aprofundados.`,
    ...
    const pastoralFilter = `\n\n${depthInstructions[depthLevel] || depthInstructions.basico}\n\n**🎯 FILTRO DE LINGUAGEM UNIVERSAL — SERMÃO PARA TODOS:**\n\nEste sermão será pregado em um CULTO PÚBLICO. Na congregação há de TUDO:\n- O bebê de colo (que sente o tom da voz)\n- A criança de 7 anos (que precisa visualizar)\n- O adolescente distraído no celular (que precisa ser fisgado)\n- O jovem que duvida da fé (que precisa de respostas reais)\n- A mãe cansada (que precisa de esperança prática)\n- O homem trabalhador simples (que precisa entender SEM dicionário)\n- A senhora idosa (que não pode se cansar com voltas)\n- O analfabeto (que aprende ouvindo, não decodificando)\n- O juiz, o médico, o doutor (que precisa respeitar a profundidade)\n- O pastor visitante (que precisa ver Cristo elevado)\n\n**REGRA DE OURO DA ACESSIBILIDADE UNIVERSAL:**\nSe uma criança de 8 anos NÃO entender uma frase ao ouvir UMA ÚNICA VEZ, REESCREVA. Se um doutor achar a frase rasa, APROFUNDE o conteúdo (não o vocabulário). A profundidade está NA VERDADE BÍBLICA, não nas palavras difíceis.\n\n**TÉCNICAS OBRIGATÓRIAS DE LINGUAGEM SIMPLES:**\n1. **Frases curtas:** Máximo 20 palavras por frase. Se passou disso, quebre em duas.\n2. **Palavras do dia a dia:** Use o vocabulário da feira, da cozinha, do ônibus, da escola — NÃO o do seminário.\n3. **Imagens concretas:** Em vez de "conceito abstrato", mostre uma CENA. Não diga "perseverança"; diga "aquele pai que acorda às 4h todo dia pra dar comida pros filhos".\n4. **Analogias simples:** Use coisas que TODOS conhecem — celular, WhatsApp, comida, futebol, novela, trânsito, mercado, família, dor de dente.\n5. **Repetição estratégica:** Idosos e crianças acompanham melhor quando uma frase-chave VOLTA 3 ou 4 vezes no sermão.\n6. **Diálogo direto:** Fale "VOCÊ" e "NÓS" alternadamente — nunca "as pessoas", "os indivíduos", "a humanidade".\n7. **Pergunta-resposta:** Faça a pergunta que o ouvinte está pensando. Depois responda. Isso prende QUALQUER idade.\n8. **Zero palavras técnicas SEM tradução:** Se precisar usar uma palavra teológica, EXPLIQUE no mesmo segundo com uma frase simples entre travessões — "graça — quer dizer, presente que a gente não merece, mas Deus dá".\n9. **Histórias curtas:** Cada ponto deve ter PELO MENOS uma micro-história de 3-4 frases. História prende criança, adulto e idoso.\n10. **Emoção real:** Fale de medo, alegria, vergonha, esperança, saudade — emoções que TODO ser humano sente.\n\n**TESTE FINAL ANTES DE ENTREGAR (faça mentalmente):**\n- ✅ Uma criança de 8 anos entende?\n- ✅ Um idoso de 80 anos consegue acompanhar sem se perder?\n- ✅ Um jovem de 15 anos NÃO bocejou?\n- ✅ Um doutor respeita a fidelidade bíblica?\n- ✅ Um analfabeto saiu sabendo o que fazer?\n- ✅ Cristo é o centro absoluto?\nSe QUALQUER resposta for "não", REESCREVA aquela parte com palavras MAIS simples e imagens MAIS concretas.\n\n**PROIBIÇÕES ABSOLUTAS:**\n- ❌ Linguagem rebuscada, eruditismo, palavras de dicionário\n- ❌ Frases longas com muitas vírgulas e orações subordinadas\n- ❌ Termos teológicos sem tradução imediata\n- ❌ Citações em latim, grego ou hebraico SEM tradução acessível\n- ❌ Pressupor que o ouvinte conhece o contexto bíblico\n- ❌ Tom acadêmico, palestra, aula universitária\n- ❌ Ironia complexa, sarcasmo, humor que exige cultura\n\n**A MENSAGEM PRECISA ALCANÇAR DESDE O BEBÊ DE COLO ATÉ O MAIS ANCIÃO. DESDE A PESSOA MAIS SIMPLES ATÉ O JUIZ MAIS RENOMADO. TODOS PRECISAM QUERER OUVIR — E RESPONDER AO QUE OUVIRAM.**\n`;
