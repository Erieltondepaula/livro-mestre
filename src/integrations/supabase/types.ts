  ...
  public: {
    Tables: {
      ...
      evaluations: {
        ...
        Relationships: [
          {
            foreignKeyName: "evaluations_book_id_fkey"
            columns: ["book_id"]
            isOneToOne: true
      ...
      note_book_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "note_book_links_book_id_fkey"
            columns: ["book_id"]
            isOneToOne: false
            referencedRelation: "books"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "note_book_links_note_id_fkey"
            columns: ["note_id"]
            isOneToOne: false
            referencedRelation: "notes"
            referencedColumns: ["id"]
      ...
      statuses: {
        ...
        Relationships: [
          {
            foreignKeyName: "statuses_book_id_fkey"
            columns: ["book_id"]
            isOneToOne: true
            referencedRelation: "books"
            referencedColumns: ["id"]
